...
function initializeConnection () {
  ...
  var credentialsAvailable = nconf.get("LDAP_BIND_USER") && (nconf.get('LDAP_BIND_PASSWORD') || nconf.get('LDAP_BIND_CREDENTIALS'));
  if (!nconf.get('ANONYMOUS_SEARCH_ENABLED') || credentialsAvailable) {
